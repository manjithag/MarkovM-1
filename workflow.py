'''
This workflow finds the ordered attributes o1,⋯, om that gives the highest mean risk.
...
def find_workflow(df : pd.DataFrame, attributes : list, theta : float):
    ...
    for val in range (1,m):
        ...
        # If calculated PRmean > theta (privacy risk probability threshold) --> Ends the calculation
